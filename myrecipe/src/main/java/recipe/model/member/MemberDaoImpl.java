...
public class MemberDaoImpl implements MemberDao {
	...
	public void sign(MemberDto dto) {
		...
		Object[] args = {dto.getEmail(),dto.getPassword(),dto.getName(),dto.getPhone(),
				dto.getPost(),dto.getAddr1(),dto.getAddr2(),dto.getTelecom()};
	...
	public boolean edit(MemberDto dto) {
		...
		int res = jdbcTemplate.update(sql,dto.getPassword(),dto.getName(),dto.getPhone(),dto.getTelecom(),
				dto.getPost(),dto.getAddr1(),dto.getAddr2(),dto.getEmail());
		return res>0;
	}
	@Override
	public boolean signcheck(String email,String name) {
		Integer origin = jdbcTemplate.queryForObject("select count(*) from member where email=? and name=?",Integer.class,new Object[] {email,name});
